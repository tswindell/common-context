...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CrdtClient_t, stringdata) + ofs \
...
const QMetaObject CrdtClient::staticMetaObject = {
    { &GrpcClient::staticMetaObject, qt_meta_stringdata_CrdtClient.data,
      qt_meta_data_CrdtClient,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CrdtClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CrdtClient.stringdata))
        return static_cast<void*>(const_cast< CrdtClient*>(this));
    return GrpcClient::qt_metacast(_clname);
}

int CrdtClient::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = GrpcClient::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
